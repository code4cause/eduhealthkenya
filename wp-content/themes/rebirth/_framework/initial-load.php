...
if ( !function_exists('js_admin_script_loader')){
	function js_admin_script_loader() {
		...
		wp_enqueue_script('jqueryui-datepicker', get_stylesheet_directory_uri() . '/_framework/enhanced-custom-fields/tpls/jqueryui/jquery-ui-1.9.2.custom.min.js');
		...
		wp_enqueue_style('jqueryui-datepicker', get_stylesheet_directory_uri() . '/_framework/enhanced-custom-fields/tpls/jqueryui/smoothness/jquery-ui-1.9.2.custom.css');
