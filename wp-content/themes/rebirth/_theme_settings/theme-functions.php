		...
		foreach ($featured_items as $i) :
			...
			$button_css_class = 'gallery';
				...
				case 'map':
					...
					break;
				case 'image':
					$button_text = $slide_link ? __('View Page', 'rebirth') : '';
					break;
				case 'audio':
					$button_text = __('Play Audio', 'rebirth');
					$button_css_class = 'audio';
					break;
				case 'video':
					$button_text = __('Play Video', 'rebirth');
					$button_css_class = 'video';
					break;
				default:
					$button_text = __('View', 'rebirth');
					break;
			}
			...
			if ($slide_type == 'image'){
				...
				$slide_items .= '<li class="video slide">';
					...
					$slide_items .= '<section class="caption bitter"'.($slide_hide_caption ? 'style="display:none;"' : '').'>';
					if (!$slide_hide_caption){ $slide_items .= $caption_heading; }
					$slide_items .= '</section>';
...
function js_social_icons(){
	...
	echo (of_get_option('js_social_icon_wordpress') ? '<a href="'.of_get_option('js_social_icon_wordpress').'" class="icon wordpress"><span class="notext"></span></a>' : '');
	echo (of_get_option('js_social_icon_podcasting') ? '<a href="'.of_get_option('js_social_icon_podcasting').'" class="icon podcasting"><span class="notext"></span></a>' : '');
